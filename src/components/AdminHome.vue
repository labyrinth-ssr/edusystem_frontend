...
<!--      <el-menu-item index="2-2">教师</el-menu-item>-->
      ...
      <el-submenu index="2-4">
        <template slot="title">批量添加</template>
        <el-menu-item index="2-4-1">学生</el-menu-item>
        <el-menu-item index="2-4-2">教师</el-menu-item>
        <el-menu-item index="2-4-3">课程</el-menu-item>
      </el-submenu>
    </el-submenu>
...
export default {
  ...
  methods: {
    ...
    addUsers(){
      ...
      this.$router.replace(
      {
        path:path === "/ "|| path===undefined?"/adduserform":"/adduserform"
      }
      );
    }
  }
